...
public class ScribeForgetPassword extends JFrame implements ActionListener {
    
    JTextField tfusername, tfname, tfquestion, tfanswer, tfpassword;
    JButton search, retrieve, back;
    
    ScribeForgetPassword() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/forgetpassword.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            try {
                String query = "select * from saccount where username = '" + tfusername.getText() + "'";
                Conn c = new Conn();
            ...
            try {
                String query = "select * from saccount where answer = '" + tfanswer.getText() + "' AND username = '" + tfusername.getText() + "'";
                Conn c = new Conn();
                ResultSet rs = c.s.executeQuery(query);
                while (rs.next()) {
