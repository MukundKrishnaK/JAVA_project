...
public class ScribeCreateProfile extends JFrame implements ActionListener {
    ...
    ScribeCreateProfile(String username) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO scribe (first_name, last_name, dob, age, gender, phone_number, country, state, city, address, aadhar_number, username) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
