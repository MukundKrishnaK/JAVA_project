...
public class ScribeViewProfile extends JFrame {
    ...
    ScribeViewProfile(String username) {
    ...
    public static void main(String[] args) {
        new ScribeViewProfile("User");  // Replace "User" with the username to view the profile
    }
}
